...
//        this._cardsList.push(obj);
    ...
    likeCard(cardId, isSet) {
        ...
        const newLikes = card.likes.filter(like => like !== myId);
        if (!isSet) newLikes.push(myId);
        card['likes'] = newLikes;
